...
impl Capability {
    pub fn new_event() -> Capability {
        ...
        c.data.string_array.insert("notifications".to_string(), Vec::new());
        c.data.string.insert("color".to_string(), String::new());
        c.data.string.insert("description".to_string(), String::new());
        c.data.uuid_array.insert("attachments".to_string(), Vec::new());
        c
    }
}